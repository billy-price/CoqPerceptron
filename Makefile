...
# coq_makefile -R . CoqPerceptron MCEBounds.v PerceptronConvergence.v PerceptronDef.v PerceptronSound.v QvecArith.v TerminationRefinement.v fuel.v fueled_perceptron.v 
#
