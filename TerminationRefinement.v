Require Import ZvecArith PerceptronDef.
  ...
  ***************************************************************************************************)
Theorem inner_perceptron_MCE_inner_perceptron_None : forall {n : nat} T (w0: Zvec (S n)),
...
Proof.
  ...
  destruct (inner_perceptron_MCE T (Zvec_plus w0 (Zvec_mult_class l (consb f)))).  destruct p. inversion H1. inversion H1.
  reflexivity. destruct a as [f l].
  inversion H. unfold inner_perceptron_MCE. destruct (correct_class (Zvec_dot w0 (consb f)) l).
...
Theorem inner_perceptron_MCE_inner_perceptron : forall {n : nat} T (w0 w : Zvec (S n)),
...
Proof.
  ...
  destruct (inner_perceptron_MCE T (Zvec_plus w0 (Zvec_mult_class l (consb f)))) eqn:H3.
  ...
  { inversion H. } (* base case T = nil *)
  destruct a as [f l]. inversion H. unfold inner_perceptron_MCE. destruct (correct_class (Zvec_dot w0 (consb f)) l) eqn: H6.
  ...
  inversion H1; subst. fold (inner_perceptron_MCE T (Zvec_plus w0 (Zvec_mult_class l (consb f)))).
  apply IHT in H2. destruct H2 as [M H2]. rewrite H2. exists (List.cons (f, l) M). auto.
  fold (inner_perceptron_MCE T (Zvec_plus w0 (Zvec_mult_class l (consb f)))). apply inner_perceptron_MCE_inner_perceptron_None in H2.
  ...
  ***************************************************************************************************)
Lemma Perceptron_MCE_MCE : forall {n : nat} (E : nat) (T M : list ((Zvec n)*bool)) (w0 w : Zvec (S n)),
...
Theorem perceptron_MCE_perceptron : forall {n : nat} (E : nat) T (w0 w : Zvec (S n)),
...
Proof.
  ...
  destruct H2 as [M' H2]. rewrite H2. fold (perceptron_MCE E T z). rewrite H1. exists (List.app M' M). auto.
  inversion H1; subst; clear H1. apply inner_perceptron_MCE_inner_perceptron_None in H2.
  unfold perceptron_MCE. rewrite H2. exists List.nil. auto. Qed.

 (***************************************************************************************************
    Show that w = Sum of Misclassified Errors
  ***************************************************************************************************)
Lemma inner_perceptron_MCE_sum_m_w : forall {n : nat} (T M: (list ((Zvec n)*bool))) (w0 w: Zvec (S n)),
  inner_perceptron_MCE T w0 = Some (M, w) -> w = Zvec_sum_class w0 M.
Proof.
  intros n T. induction T; intros.
  { inversion H. } (* base case T = nil *)
  destruct a as [f l]. inversion H. destruct (correct_class (Zvec_dot w0 (consb f)) l).
  apply IHT in H1. apply H1. destruct (inner_perceptron_MCE T (Zvec_plus w0 (Zvec_mult_class l (consb f)))) eqn:H3;
  [destruct p as [M' w']; apply IHT in H3|]; inversion H1; subst; clear H1; auto. Qed.

Lemma perceptron_MCE_sum_m_w : forall {n : nat} (E : nat) (T M: (list ((Zvec n)*bool))) (w0 w: Zvec (S n)),
  perceptron_MCE E T w0 = Some (M, w) -> w = Zvec_sum_class w0 M.
Proof.
  intros n E. induction E; intros.
  { inversion H. } (* base case *)
  inversion H. destruct (inner_perceptron_MCE T w0) eqn:H2. destruct p as [M' w'].
  apply inner_perceptron_MCE_sum_m_w in H2. destruct (perceptron_MCE E T w') eqn: H3. destruct p as [M'' W''].
  ...
  ***************************************************************************************************)
Theorem perceptron_MCE_S : forall {n : nat} (E : nat) (w w0 : Zvec (S n)) (T M : list ((Zvec n)*bool)),
...
Lemma perceptron_MCE_done : forall {n : nat} (E0 E : nat) (w w0 : Zvec (S n)) (T M : list ((Zvec n)*bool)),
...
Proof.
  ...
  ***************************************************************************************************)
Lemma inner_perceptron_MCE_nil_false : forall {n: nat} (w0 w: Zvec (S n)) (T : list ((Zvec n)*bool)),
...
Proof.
  ...
  destruct (correct_class (Zvec_dot w0 (consb f)) l).
    ...
    destruct (inner_perceptron_MCE T (Zvec_plus w0 (Zvec_mult_class l (consb f))));
...
Proof.
  ...
  ***************************************************************************************************)
Lemma MCE_eq_perceptron_MCE : forall {n : nat} (E : nat) (w0 : Zvec (S n)) (T : list ((Zvec n)*bool)),
 MCE E T w0 = MCE (S E) T w0 ->
 perceptron_MCE (S E) T w0 = Some ((MCE E T w0), Zvec_sum_class w0 (MCE E T w0)).
Proof.
  intros n E. induction E; intros.
